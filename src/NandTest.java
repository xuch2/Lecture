...
/* -15 를 bit 로 표현해보자 ~
   ...
   15 = X 가 될 것이므로
                  00001111(2) = 15
   꼼수를 적용하면 11110001(2) = -15

   ~112 를 bit 로 표기하고 구해보자 ~
   112 는 64 + 32 + 16 이므로
                     01110000
   ~(not) 을 적용하면 10001111
   위와 마찬가지로 이 녀석이 얼마인지를 모르니
   동일하게 -X 로 놓고 꼼수를 적용한다.
...
public class NandTest {
    public static void main(String[] args) {
        ...
        /* 음수를 bit 로 해석 하는 방법(2 의 보수) - 꼼수
           ...
           결론: 양수를 음수로 바꾼 기법임
                 음수를 양수로 바꿀 수도 있음 */
        System.out.println("positivie = " + positive);
        ...
        * */
        ...
        /* 숙제 7-1. -137 을 bit 로 표현하시오.
           ...
           0 1000 1001
                     ...
                     15   11   7    3
           숙제 7-2. 1000 1010 1111 1010 을 10 진수로 표현하시오.
